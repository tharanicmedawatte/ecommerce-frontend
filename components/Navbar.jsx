...
// Top navigation bar — shows on every page via app/layout.jsx.
// Handles: logo, nav links, search, cart count, login/logout.
// =============================================================================
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* Cart */}
            <Link href="/cart" className="relative p-2 text-gray-600 hover:text-brand-700
                                          transition-colors">
            ...
            {isLoading ? (
              ...
              <a href="/api/auth/login"
                className="bg-brand-600 hover:bg-brand-700 text-white text-sm
                           font-medium px-4 py-2 rounded-full transition-colors">
                Login
              </a>
            )}
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-gray-100 py-4 space-y-3">
            <form onSubmit={handleSearch} className="flex items-center bg-gray-100
                                                      rounded-full px-4 py-2 mx-2">
            ...
            <Link href="/products?category=electronics" onClick={() => setMenuOpen(false)}
              className="block px-4 py-2 text-gray-700 hover:bg-gray-50">
              Electronics
            </Link>
            <Link href="/products?category=clothing" onClick={() => setMenuOpen(false)}
              className="block px-4 py-2 text-gray-700 hover:bg-gray-50">
              Clothing
            </Link>
            {user ? (
              ...
              <a href="/api/auth/login"
                className="block px-4 py-2 text-brand-600 font-medium hover:bg-gray-50">
                Login / Register
              </a>
            )}
          </div>
